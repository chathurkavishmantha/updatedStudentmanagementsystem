 ...
 class CreateOptions extends Component {
    ...
    handleForm = (e) => {
        ...
        .then(res => {
            ...
            this.props.history.push('/exam_create_option_answers');
                        ...
                        <form className="text-center" method="POST" onSubmit={this.handleForm}>
                                    ...
                                    <div className="form-row d-flex justify-content-center">
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <label htmlFor="validationServer01">Question Name:</label>
                                            <input type="text" className="form-control" id="validationServer01" name="subject_code" onChange={this.handleInput} required />
                                            
                                            <label htmlFor="validationServer01">Option Answers:</label>
                                            <textarea type="text" className="form-control" id="validationServer01" name="subject_code" onChange={this.handleInput} required />
                                        
                                            <label htmlFor="validationServer01">Option Value:</label>
