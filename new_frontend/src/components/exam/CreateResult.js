                ...
                <div>
                    ...
                    <div className="text-center">
                        ...
                        <form className="text-center" method="POST" onSubmit={this.handleForm}>
                                    <h4><h1>Create Results </h1><br/>
                                    </h4>
                                    <div className="form-row d-flex justify-content-center">
                                        <div className="col-md-3 mb-3">
                                            {/* <input type="text" className="form-control" id="" name="id" onChange={this.handleInput} required /> */}
                                            <label htmlFor="validationServer01">Question Number :</label>
                                            <input type="number" className="form-control" id="validationServer01" name="subject_name" onChange={this.handleInput} required />                                        
                                            
                                            <label htmlFor="validationServer01">Option Number:</label>
                                            <input type="number" className="form-control" id="validationServer01" name="subject_code" onChange={this.handleInput} required />
                                        
                                            <label htmlFor="validationServer01">Points:</label>
                                            <input type="number" className="form-control" id="validationServer01" name="subject_code" onChange={this.handleInput} required />
...
export default connect(mapStateToProps, null)(CreateResult);
